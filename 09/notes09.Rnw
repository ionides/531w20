...
\frametitle{Joinly multivariate normal vectors}
...
\frametitle{The he Kalman matrix recursions}
...
\item  The prediction recursions [KF3--4] are relatively easy to demonstrate, but it is a good exercise to go through the algebra to your own satisfaction. 
...
\item  [KF5--6] can be deduced by completing the square in an expression for the joint density,
$f_{X_nY_n|Y_{1:n-1}} (
